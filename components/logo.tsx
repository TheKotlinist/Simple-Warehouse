...
export const LogoIcon = ({
    ...
    return (
        <div
            className={cn(
                'flex size-7 items-center justify-center rounded-md bg-foreground text-background text-lg font-bold',
                className
            )}
        >
            W
